...
LABEL Name="senzing/go-grpcing-builder" \
...
ENV REFRESHED_AT=2023-02-22
LABEL Name="senzing/go-grpcing" \
      Maintainer="support@senzing.com" \
      Version="0.0.5"

# Copy files from prior step.

COPY --from=go_builder "/output/linux/go-grpcing" "/app/go-grpcing"
